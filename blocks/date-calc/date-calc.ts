...
export class DateCalc {
    schema: BaseSchema = {
        ...
        toggleName: "feature.cbk.datecalculator",
        ...
        runtime: async (cbk) => {
            ...
            switch (fnTypes[fn]) {
                case "periodUnit":
                    const newDateVarName = cbk.getElementValue(
                        "new_datetime_variable"
                    );
                    ...
                    break;
                case "difference":
                    const newDiffVarName =
                        cbk.getElementValue("new_diff_variable");
                    const dateA = cbk.getVariable(
                        cbk.getElementValue("diff_date_a")
                    );
                    const dateB = cbk.getVariable(
                        cbk.getElementValue("diff_date_b")
                    );
